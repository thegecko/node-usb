...
export declare function listeners<K extends keyof DeviceEvents>(event: K): Function[];
export declare function rawListeners<K extends keyof DeviceEvents>(event: K): Function[];
 ...
 */
export declare function getDeviceList(): ExtendedDevice[];
